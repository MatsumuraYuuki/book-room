...
2. プロフィールダッシュボード機能（統計情報、読書中の本、最近読了した本）
3. ビューアー機能
...
| マイページ | `/profile` | プロフィール表示 | ⬜ 一部実装済み（ダッシュボード機能は本棚実装後に追加予定） |
...
┌──────────────────────────────────────────────────┐
│  私の本棚                                         │
│  📚 全12冊（未読: 5冊、読書中: 3冊、読了: 4冊）  │  ← 本数表示
│                                                  │
│  [全て] [未読] [読書中] [読了]  [新しい順 ▼]    │  ← フィルターと並び替え
│                                                  │
├──────────────────────────────────────────────────┤
│  ┌─────────────────┐  ┌─────────────────┐       │
│  │ [読書中]         │  │ [未読]          │       │  ← ステータスバッジ
...
**実装順序:**
- フェーズ1: 本棚画面（/my-books）の実装
- フェーズ2: プロフィールページにダッシュボード機能を追加
...
13. ビューアー画面実装
14. プロフィールAPI実装✅
15. マイページ実装✅（基本機能のみ、ダッシュボード機能は11で追加）
...
ActiveRecord::Schema[7.2].define(version: 2025_11_28_061517) do
  ...
  create_table "aozora_books", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "aozora_code", null: false
    ...
    t.index ["aozora_code"], name: "index_aozora_books_on_aozora_code", unique: true
